...
function ImageWithCaption(props: ImageWithCaptionProps) {
  ...
  return (
    <Box className={classes.centeredContent} paddingBottom={3}>
      ...
      <Typography variant="h4" fontFamily={'Optima, sans-serif'} lineHeight={1.5} fontSize={20} textAlign={'center'}>
        {props.caption}
      </Typography>
    </Box>
  );
...
function Paragraph(props: ParagraphProps) {
  return (
    <Typography variant="h4" fontFamily={'Optima, sans-serif'} lineHeight={1.5} fontSize={20} paddingBottom={3}>
      {props.text}
    </Typography>
  );
}
...
export function BlogPost() {
  ...
  return (
    <Box className={classes.centeredContent}>
      <Typography variant="h2" fontFamily={'Optima, sans-serif'}>
        Hello World!
      </Typography>
      <Typography fontSize={20} fontFamily={'Optima, sans-serif'} paddingBottom={2}>
        October 15, 2023
      </Typography>
      ...
      <ImageWithCaption path="/Chicago1.png" caption={'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'} />
      <Paragraph

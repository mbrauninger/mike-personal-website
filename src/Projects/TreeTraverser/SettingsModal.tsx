                ...
                <Box sx={{ position: 'relative', bottom: 15 }}>
                    ...
                    <Box>
                        ...
                        <div style={{ fontSize: 13, position: 'relative', bottom: 42 }}>
                            Note, the tree generator will attempt to randomly place nodes in the canvas until there is
                            no more room. If the number you input contains more nodes than can fit on the screen, the
                            tree generator will construct a tree with as many nodes as possible.
                        </div>
                    </Box>
                </Box>
            </Box>
